修正: SLOT_1は投稿済みなので触らない。SLOT_2とSLOT_3だけ下記確定文で、github-actions[bot]として「承認申請」＋「推奨投稿案」を一字一句変えず再出力せよ。AI言い換え禁止。education・#PR不要。洗腸液禁止。「看護師20年なのに」禁止。麹水・血糖値ネタ禁止。各ツリー返信は180文字以上。
