...
## ④ 改善提案（最大3件）
{'1. 平均いいねが低い場合: ライターに文体の微調整を依頼する' if avg_likes < 20 else '1. 良好なパフォーマンスを維持中'}
{'2. バズ率向上のため: 情報リサーチにトレンド分析の精度向上を依頼する' if buzz_count == 0 else ''}
